...
<html lang="en">
  <head>
    ...
    <title>Skill Meter-Select Subject</title>
        ...
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form action="./teststart.php" method="get" role="form" class="contactForm">
                            
                            <div class="form-group">
							<span style="color:#6e6e6e;"><b>Subjects</b></span><br><hr>
                    ...
                    <?php
						if(mysqli_num_rows($data)>0)
						{
							...
							{
					?>
					<input type="radio" name="catid" class="form-control1"  value="<?php echo $row['catid'];?>" /><span style="color:#6e6e6e;" > <?php echo $row['catname'];?></span><br>
