...
require('./model/dbconnection.php');
	echo $sqlSelect="SELECT * FROM papercat  where catid='$catid'";
...
<html lang="en">
  <head>
    ...
    <title>Skill Meter-Edit Subject</title>
  ...
  <body>
				...
				<div class="container">					
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index.html"><h1><span>Improve</span>Skills</h1></a>
						</div>
					</div>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="adminreport.php">Reports</a></li>							
	...
	<div class="services">
		<div class="container">
			<h3 align="center">Edit Examination Subjects</h3>
			<hr>
			
			
			<div class="col-md-6">
				<div class="media">
				<form action="./model/updatecat.php" method="POST">
				...
				<tr>
						...
						<td>
							...
							<INPUT TYPE="INT" NAME="catid" VALUE="<?php echo $row['catid'];?>" readonly>
							 </span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><span style="color:#6e6e6e;">Description</span></td>
						<td>
							<span style="color:#6e6e6e;">
							<INPUT TYPE="TEXT" NAME="catdetail" VALUE="<?php echo $row['catdetail'];?>" >
							 </span>
						</td>
					</tr>
					...
					<button type="submit" name="btn_updatecat" class="btn btn-primary btn-lg" required="required">Submit</button>
					</div>
					</td>
					</tr>
				</table>
